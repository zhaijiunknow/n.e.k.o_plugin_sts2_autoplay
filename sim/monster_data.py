...
MOVE_TABLES = {
    ...
    'AXE_RUBY_RAIDER': {
        'SWING_1': EnemyMove('SWING_1', damage=6, block=6, hits=1, followup='SWING_2'),
        'SWING_2': EnemyMove('SWING_2', damage=6, block=6, hits=1, followup='BIG_SWING'),
        'BIG_SWING': EnemyMove('BIG_SWING', damage=13, block=0, hits=1, followup='SWING_1'),
    },
    'AXEBOT': {
        'BOOT_UP_MOVE': EnemyMove('BOOT_UP_MOVE', damage=0, block=15, hits=1, buff_power='STRENGTH_POWER', buff_amount=0, followup=''),
        'ONE_TWO_MOVE': EnemyMove('ONE_TWO_MOVE', damage=11, block=0, hits=2, followup=''),
        'HAMMER_UPPERCUT_MOVE': EnemyMove('HAMMER_UPPERCUT_MOVE', damage=18, block=0, hits=1, buff_power='FRAIL_POWER', buff_amount=0, followup=''),
    },
    'BIG_DUMMY': {
        'NOTHING': EnemyMove('NOTHING', damage=0, block=0, hits=1, followup='NOTHING'),
    },
    'BOWLBUG_EGG': {
        'BITE_MOVE': EnemyMove('BITE_MOVE', damage=8, block=8, hits=1, followup='BITE_MOVE'),
    },
    'BOWLBUG_NECTAR': {
        'THRASH_MOVE': EnemyMove('THRASH_MOVE', damage=0, block=0, hits=1, followup='BUFF_MOVE'),
        'BUFF_MOVE': EnemyMove('BUFF_MOVE', damage=0, block=0, hits=1, buff_power='STRENGTH_POWER', buff_amount=0, followup='THRASH2_MOVE'),
    ...
    'BRUTE_RUBY_RAIDER': {
        ...
        'ROAR_MOVE': EnemyMove('ROAR_MOVE', damage=0, block=0, hits=1, buff_power='STRENGTH_POWER', buff_amount=0, followup=''),
    },
    'BYGONE_EFFIGY': {
    ...
    'CALCIFIED_CULTIST': {
        'INCANTATION_MOVE': EnemyMove('INCANTATION_MOVE', damage=0, block=0, hits=1, buff_power='RITUAL_POWER', buff_amount=0, followup=''),
        'DARK_STRIKE_MOVE': EnemyMove('DARK_STRIKE_MOVE', damage=11, block=0, hits=1, followup=''),
    },
    'CEREMONIAL_BEAST': {
        'STAMP_MOVE': EnemyMove('STAMP_MOVE', damage=0, block=0, hits=1, buff_power='PLOW_POWER', buff_amount=0, followup='PLOW_MOVE'),
        ...
        'BEAST_CRY_MOVE': EnemyMove('BEAST_CRY_MOVE', damage=0, block=0, hits=1, buff_power='RINGING_POWER', buff_amount=0, followup='STOMP_MOVE'),
    ...
    'CORPSE_SLUG': {
        ...
        'GOOP_MOVE': EnemyMove('GOOP_MOVE', damage=0, block=0, hits=1, buff_power='FRAIL_POWER', buff_amount=0, followup='WHIP_SLAP_MOVE'),
    },
    ...
    'CRUSHER': {
        ...
        'BUG_STING_MOVE': EnemyMove('BUG_STING_MOVE', damage=7, block=0, hits=1, buff_power='FRAIL_POWER', buff_amount=0, followup='ADAPT_MOVE'),
        'ADAPT_MOVE': EnemyMove('ADAPT_MOVE', damage=0, block=0, hits=1, buff_power='STRENGTH_POWER', buff_amount=0, followup='GUARDED_STRIKE_MOVE'),
        'GUARDED_STRIKE_MOVE': EnemyMove('GUARDED_STRIKE_MOVE', damage=14, block=0, hits=1, followup='THRASH_MOVE'),
    },
    'CUBEX_CONSTRUCT': {
        'CHARGE_UP_MOVE': EnemyMove('CHARGE_UP_MOVE', damage=0, block=0, hits=1, buff_power='STRENGTH_POWER', buff_amount=0, followup='REPEATER_BLAST_MOVE'),
        'REPEATER_BLAST_MOVE': EnemyMove('REPEATER_BLAST_MOVE', damage=8, block=0, hits=1, buff_power='STRENGTH_POWER', buff_amount=0, followup='REPEATER_BLAST_MOVE_2'),
        'REPEATER_BLAST_MOVE_2': EnemyMove('REPEATER_BLAST_MOVE_2', damage=8, block=0, hits=1, buff_power='STRENGTH_POWER', buff_amount=0, followup='EXPEL_MOVE'),
    ...
    'DECIMILLIPEDE_SEGMENT': {
        ...
        'BULK_MOVE': EnemyMove('BULK_MOVE', damage=7, block=0, hits=1, buff_power='STRENGTH_POWER', buff_amount=0, followup='WRITHE_MOVE'),
        'CONSTRICT_MOVE': EnemyMove('CONSTRICT_MOVE', damage=9, block=0, hits=1, buff_power='WEAK_POWER', buff_amount=0, followup='BULK_MOVE'),
        'REATTACH_MOVE': EnemyMove('REATTACH_MOVE', damage=0, block=0, hits=1, followup=''),
    },
    'DEVOTED_SCULPTOR': {
        'FORBIDDEN_INCANTATION_MOVE': EnemyMove('FORBIDDEN_INCANTATION_MOVE', damage=0, block=0, hits=1, buff_power='RITUAL_POWER', buff_amount=0, followup=''),
        'SAVAGE_MOVE': EnemyMove('SAVAGE_MOVE', damage=15, block=0, hits=1, followup=''),
    },
    'ENTOMANCER': {
        'PHEROMONE_SPIT_MOVE': EnemyMove('PHEROMONE_SPIT_MOVE', damage=0, block=0, hits=1, buff_power='STRENGTH_POWER', buff_amount=0, followup='BEES_MOVE'),
    ...
    'EXOSKELETON': {
        ...
        'ENRAGE_MOVE': EnemyMove('ENRAGE_MOVE', damage=0, block=0, hits=1, buff_power='STRENGTH_POWER', buff_amount=0, followup=''),
    },
    'EYE_WITH_TEETH': {
    ...
    'FAKE_MERCHANT_MONSTER': {
        ...
        'THROW_RELIC_MOVE': EnemyMove('THROW_RELIC_MOVE', damage=10, block=0, hits=1, buff_power='FRAIL_POWER', buff_amount=0, followup=''),
        'ENRAGE_MOVE': EnemyMove('ENRAGE_MOVE', damage=0, block=0, hits=1, buff_power='STRENGTH_POWER', buff_amount=0, followup=''),
    },
    'FAT_GREMLIN': {
    ...
    'FLAIL_KNIGHT': {
        'WAR_CHANT': EnemyMove('WAR_CHANT', damage=0, block=0, hits=1, buff_power='STRENGTH_POWER', buff_amount=0, followup=''),
    ...
    'FOGMOG': {
        ...
        'SWIPE_MOVE': EnemyMove('SWIPE_MOVE', damage=9, block=0, hits=1, buff_power='STRENGTH_POWER', buff_amount=0, followup=''),
        'SWIPE_RANDOM_MOVE': EnemyMove('SWIPE_RANDOM_MOVE', damage=9, block=0, hits=1, buff_power='STRENGTH_POWER', buff_amount=0, followup='HEADBUTT_MOVE'),
        'HEADBUTT_MOVE': EnemyMove('HEADBUTT_MOVE', damage=16, block=0, hits=1, followup='SWIPE_MOVE'),
    },
    'FOSSIL_STALKER': {
        'TACKLE_MOVE': EnemyMove('TACKLE_MOVE', damage=11, block=0, hits=1, buff_power='FRAIL_POWER', buff_amount=0, followup=''),
    ...
    'FROG_KNIGHT': {
        'FOR_THE_QUEEN': EnemyMove('FOR_THE_QUEEN', damage=0, block=0, hits=1, buff_power='STRENGTH_POWER', buff_amount=0, followup=''),
        'STRIKE_DOWN_EVIL': EnemyMove('STRIKE_DOWN_EVIL', damage=23, block=0, hits=1, followup='FOR_THE_QUEEN'),
        'TONGUE_LASH': EnemyMove('TONGUE_LASH', damage=14, block=0, hits=1, buff_power='FRAIL_POWER', buff_amount=0, followup='STRIKE_DOWN_EVIL'),
    ...
    'FUZZY_WURM_CRAWLER': {
        ...
        'INHALE': EnemyMove('INHALE', damage=0, block=0, hits=1, buff_power='STRENGTH_POWER', buff_amount=0, followup=''),
    },
    'GLOBE_HEAD': {
        'THUNDER_STRIKE': EnemyMove('THUNDER_STRIKE', damage=7, block=0, hits=3, followup='GALVANIC_BURST'),
        'SHOCKING_SLAP': EnemyMove('SHOCKING_SLAP', damage=14, block=0, hits=1, buff_power='FRAIL_POWER', buff_amount=0, followup='THUNDER_STRIKE'),
        'GALVANIC_BURST': EnemyMove('GALVANIC_BURST', damage=17, block=0, hits=1, buff_power='STRENGTH_POWER', buff_amount=0, followup='SHOCKING_SLAP'),
    },
    'GREMLIN_MERC': {
    ...
    'HAUNTED_SHIP': {
        ...
        'HAUNT_MOVE': EnemyMove('HAUNT_MOVE', damage=0, block=0, hits=1, buff_power='WEAK_POWER', buff_amount=0, followup='SWIPE_MOVE'),
    },
    'HUNTER_KILLER': {
        'TENDERIZING_GOOP_MOVE': EnemyMove('TENDERIZING_GOOP_MOVE', damage=0, block=0, hits=1, buff_power='TENDER_POWER', buff_amount=0, followup=''),
    ...
    'INFESTED_PRISM': {
        ...
        'RADIATE_MOVE': EnemyMove('RADIATE_MOVE', damage=13, block=13, hits=1, followup='WHIRLWIND_MOVE'),
        'WHIRLWIND_MOVE': EnemyMove('WHIRLWIND_MOVE', damage=6, block=0, hits=1, followup='PULSATE_MOVE'),
        'PULSATE_MOVE': EnemyMove('PULSATE_MOVE', damage=10, block=22, hits=1, buff_power='VITAL_SPARK_POWER', buff_amount=0, followup='JAB_MOVE'),
    },
    'INKLET': {
    ...
    'KIN_FOLLOWER': {
        ...
        'POWER_DANCE_MOVE': EnemyMove('POWER_DANCE_MOVE', damage=0, block=0, hits=1, buff_power='STRENGTH_POWER', buff_amount=0, followup='QUICK_SLASH_MOVE'),
    },
    'KIN_PRIEST': {
        'ORB_OF_FRAILTY_MOVE': EnemyMove('ORB_OF_FRAILTY_MOVE', damage=9, block=0, hits=1, buff_power='FRAIL_POWER', buff_amount=0, followup='ORB_OF_WEAKNESS_MOVE'),
        'ORB_OF_WEAKNESS_MOVE': EnemyMove('ORB_OF_WEAKNESS_MOVE', damage=9, block=0, hits=1, buff_power='WEAK_POWER', buff_amount=0, followup='BEAM_MOVE'),
    ...
    'KNOWLEDGE_DEMON': {
        ...
        'PONDER_MOVE': EnemyMove('PONDER_MOVE', damage=13, block=0, hits=1, buff_power='STRENGTH_POWER', buff_amount=0, followup=''),
    },
    'LAGAVULIN_MATRIARCH': {
        ...
        'SLASH2_MOVE': EnemyMove('SLASH2_MOVE', damage=14, block=14, hits=1, followup='SOUL_SIPHON_MOVE'),
        'DISEMBOWEL_MOVE': EnemyMove('DISEMBOWEL_MOVE', damage=10, block=0, hits=1, followup='SLASH2_MOVE'),
        'SOUL_SIPHON_MOVE': EnemyMove('SOUL_SIPHON_MOVE', damage=0, block=0, hits=1, buff_power='STRENGTH_POWER', buff_amount=0, followup='SLASH_MOVE'),
    },
    'LEAF_SLIME_M': {
    ...
    'LIVING_FOG': {
        'ADVANCED_GAS_MOVE': EnemyMove('ADVANCED_GAS_MOVE', damage=9, block=0, hits=1, buff_power='SMOGGY_POWER', buff_amount=0, followup='BLOAT_MOVE'),
    ...
    'LIVING_SHIELD': {
        ...
        'SMASH_MOVE': EnemyMove('SMASH_MOVE', damage=18, block=0, hits=1, buff_power='STRENGTH_POWER', buff_amount=0, followup='SMASH_MOVE'),
    },
    'LOUSE_PROGENITOR': {
        ...
        'CURL_AND_GROW_MOVE': EnemyMove('CURL_AND_GROW_MOVE', damage=0, block=18, hits=1, buff_power='STRENGTH_POWER', buff_amount=0, followup=''),
    },
    'MAGI_KNIGHT': {
        'POWER_SHIELD_MOVE': EnemyMove('POWER_SHIELD_MOVE', damage=7, block=9, hits=1, followup='DAMPEN_MOVE'),
        'DAMPEN_MOVE': EnemyMove('DAMPEN_MOVE', damage=0, block=0, hits=1, followup='RAM_MOVE'),
        'PREP_MOVE': EnemyMove('PREP_MOVE', damage=0, block=9, hits=1, followup='MAGIC_BOMB'),
    ...
    'MAWLER': {
        ...
        'ROAR_MOVE': EnemyMove('ROAR_MOVE', damage=0, block=0, hits=1, buff_power='VULNERABLE_POWER', buff_amount=0, followup=''),
    ...
    'MECHA_KNIGHT': {
        ...
        'WINDUP_MOVE': EnemyMove('WINDUP_MOVE', damage=0, block=0, hits=1, buff_power='STRENGTH_POWER', buff_amount=0, followup='HEAVY_CLEAVE_MOVE'),
    ...
    'MYTE': {
        ...
        'SUCK_MOVE': EnemyMove('SUCK_MOVE', damage=6, block=0, hits=1, buff_power='STRENGTH_POWER', buff_amount=0, followup='TOXIC_MOVE'),
    },
    'NIBBIT': {
        'BUTT_MOVE': EnemyMove('BUTT_MOVE', damage=13, block=0, hits=1, followup='SLICE_MOVE'),
        'SLICE_MOVE': EnemyMove('SLICE_MOVE', damage=7, block=6, hits=1, followup='HISS_MOVE'),
        'HISS_MOVE': EnemyMove('HISS_MOVE', damage=0, block=0, hits=1, buff_power='STRENGTH_POWER', buff_amount=0, followup='BUTT_MOVE'),
    },
    'NOISEBOT': {
    ...
    'OVICOPTER': {
        'LAY_EGGS_MOVE': EnemyMove('LAY_EGGS_MOVE', damage=0, block=0, hits=1, buff_power='MINION_POWER', buff_amount=0, followup='SMASH_MOVE'),
        'SMASH_MOVE': EnemyMove('SMASH_MOVE', damage=17, block=0, hits=1, followup='TENDERIZER_MOVE'),
        'TENDERIZER_MOVE': EnemyMove('TENDERIZER_MOVE', damage=8, block=0, hits=1, buff_power='VULNERABLE_POWER', buff_amount=0, followup=''),
        'NUTRITIONAL_PASTE_MOVE': EnemyMove('NUTRITIONAL_PASTE_MOVE', damage=0, block=0, hits=1, buff_power='STRENGTH_POWER', buff_amount=0, followup='SMASH_MOVE'),
    },
    'OWL_MAGISTRATE': {
        ...
        'JUDICIAL_FLIGHT': EnemyMove('JUDICIAL_FLIGHT', damage=0, block=0, hits=1, buff_power='SOAR_POWER', buff_amount=0, followup='VERDICT'),
        'VERDICT': EnemyMove('VERDICT', damage=36, block=0, hits=1, buff_power='VULNERABLE_POWER', buff_amount=0, followup='MAGISTRATE_SCRUTINY'),
    },
    'PARAFRIGHT': {
    ...
    'PHANTASMAL_GARDENER': {
        ...
        'ENLARGE_MOVE': EnemyMove('ENLARGE_MOVE', damage=0, block=0, hits=1, buff_power='STRENGTH_POWER', buff_amount=0, followup='BITE_MOVE'),
    },
    'PHROG_PARASITE': {
    ...
    'PUNCH_CONSTRUCT': {
        ...
        'FAST_PUNCH_MOVE': EnemyMove('FAST_PUNCH_MOVE', damage=6, block=0, hits=1, buff_power='FRAIL_POWER', buff_amount=0, followup=''),
    },
    'QUEEN': {
        'PUPPET_STRINGS_MOVE': EnemyMove('PUPPET_STRINGS_MOVE', damage=0, block=0, hits=1, buff_power='CHAINS_OF_BINDING_POWER', buff_amount=0, followup='YOU_ARE_MINE_MOVE'),
        'YOU_ARE_MINE_MOVE': EnemyMove('YOU_ARE_MINE_MOVE', damage=0, block=0, hits=1, buff_power='VULNERABLE_POWER', buff_amount=0, followup=''),
        'BURN_BRIGHT_FOR_ME_MOVE': EnemyMove('BURN_BRIGHT_FOR_ME_MOVE', damage=0, block=0, hits=1, buff_power='STRENGTH_POWER', buff_amount=0, followup=''),
        ...
        'ENRAGE_MOVE': EnemyMove('ENRAGE_MOVE', damage=0, block=0, hits=1, buff_power='STRENGTH_POWER', buff_amount=0, followup='OFF_WITH_YOUR_HEAD_MOVE'),
    },
    'ROCKET': {
        ...
        'CHARGE_UP_MOVE': EnemyMove('CHARGE_UP_MOVE', damage=0, block=0, hits=1, buff_power='STRENGTH_POWER', buff_amount=0, followup='LASER_MOVE'),
    ...
    'SCROLL_OF_BITING': {
        ...
        'MORE_TEETH': EnemyMove('MORE_TEETH', damage=0, block=0, hits=1, buff_power='STRENGTH_POWER', buff_amount=0, followup='CHEW'),
    },
    'SEAPUNK': {
        ...
        'BUBBLE_BURP_MOVE': EnemyMove('BUBBLE_BURP_MOVE', damage=0, block=8, hits=1, buff_power='STRENGTH_POWER', buff_amount=0, followup='SEA_KICK_MOVE'),
    },
    'SEWER_CLAM': {
        'PRESSURIZE_MOVE': EnemyMove('PRESSURIZE_MOVE', damage=0, block=0, hits=1, buff_power='STRENGTH_POWER', buff_amount=0, followup=''),
        'JET_MOVE': EnemyMove('JET_MOVE', damage=11, block=0, hits=1, followup=''),
    },
    'SHRINKER_BEETLE': {
        'SHRINKER_MOVE': EnemyMove('SHRINKER_MOVE', damage=0, block=0, hits=1, buff_power='SHRINK_POWER', buff_amount=0, followup='CHOMP_MOVE'),
    ...
    'SKULKING_COLONY': {
        ...
        'INERTIA_MOVE': EnemyMove('INERTIA_MOVE', damage=11, block=0, hits=1, buff_power='STRENGTH_POWER', buff_amount=0, followup='PIERCING_STABS_MOVE'),
    ...
    'SLIMED_BERSERKER': {
        ...
        'LEECHING_HUG_MOVE': EnemyMove('LEECHING_HUG_MOVE', damage=0, block=0, hits=1, buff_power='STRENGTH_POWER', buff_amount=0, followup='SMOTHER_MOVE'),
    ...
    'SLITHERING_STRANGLER': {
        'CONSTRICT': EnemyMove('CONSTRICT', damage=0, block=0, hits=1, buff_power='CONSTRICT_POWER', buff_amount=0, followup=''),
    ...
    'SLUDGE_SPINNER': {
        'OIL_SPRAY_MOVE': EnemyMove('OIL_SPRAY_MOVE', damage=9, block=0, hits=1, buff_power='WEAK_POWER', buff_amount=0, followup=''),
        'SLAM_MOVE': EnemyMove('SLAM_MOVE', damage=12, block=0, hits=1, followup=''),
        'RAGE_MOVE': EnemyMove('RAGE_MOVE', damage=7, block=0, hits=1, buff_power='STRENGTH_POWER', buff_amount=0, followup=''),
    },
    'SLUMBERING_BEETLE': {
    ...
    'SOUL_FYSH': {
        ...
        'FADE_MOVE': EnemyMove('FADE_MOVE', damage=0, block=0, hits=1, buff_power='INTANGIBLE_POWER', buff_amount=0, followup='SCREAM_MOVE'),
        'SCREAM_MOVE': EnemyMove('SCREAM_MOVE', damage=15, block=0, hits=1, buff_power='VULNERABLE_POWER', buff_amount=0, followup='BECKON_MOVE'),
    },
    'SOUL_NEXUS': {
        ...
        'DRAIN_LIFE_MOVE': EnemyMove('DRAIN_LIFE_MOVE', damage=19, block=0, hits=1, buff_power='WEAK_POWER', buff_amount=0, followup=''),
    },
    'SPECTRAL_KNIGHT': {
        'HEX': EnemyMove('HEX', damage=0, block=0, hits=1, buff_power='HEX_POWER', buff_amount=0, followup='SOUL_SLASH'),
    ...
    'SPINY_TOAD': {
        'PROTRUDING_SPIKES_MOVE': EnemyMove('PROTRUDING_SPIKES_MOVE', damage=0, block=0, hits=1, buff_power='THORNS_POWER', buff_amount=0, followup='SPIKE_EXPLOSION_MOVE'),
        'SPIKE_EXPLOSION_MOVE': EnemyMove('SPIKE_EXPLOSION_MOVE', damage=25, block=0, hits=1, buff_power='THORNS_POWER', buff_amount=0, followup='TONGUE_LASH_MOVE'),
        'TONGUE_LASH_MOVE': EnemyMove('TONGUE_LASH_MOVE', damage=19, block=0, hits=1, followup='PROTRUDING_SPIKES_MOVE'),
    },
    'STABBOT': {
        'STAB_MOVE': EnemyMove('STAB_MOVE', damage=12, block=0, hits=1, buff_power='FRAIL_POWER', buff_amount=0, followup='STAB_MOVE'),
    },
    'TEN_HP_MONSTER': {
        'NOTHING': EnemyMove('NOTHING', damage=0, block=0, hits=1, followup='NOTHING'),
    },
    'TERROR_EEL': {
        ...
        'THRASH_MOVE': EnemyMove('THRASH_MOVE', damage=4, block=0, hits=1, buff_power='VIGOR_POWER', buff_amount=0, followup='CRASH_MOVE'),
        'STUN_MOVE': EnemyMove('STUN_MOVE', damage=0, block=0, hits=1, followup='TERROR_MOVE'),
        'TERROR_MOVE': EnemyMove('TERROR_MOVE', damage=0, block=0, hits=1, buff_power='VULNERABLE_POWER', buff_amount=0, followup='CRASH_MOVE'),
    },
    'TEST_SUBJECT': {
        'RESPAWN_MOVE': EnemyMove('RESPAWN_MOVE', damage=0, block=0, hits=1, buff_power='NEMESIS_POWER', buff_amount=0, followup=''),
        'BITE_MOVE': EnemyMove('BITE_MOVE', damage=22, block=0, hits=1, followup='SKULL_BASH_MOVE'),
        'SKULL_BASH_MOVE': EnemyMove('SKULL_BASH_MOVE', damage=16, block=0, hits=1, buff_power='VULNERABLE_POWER', buff_amount=0, followup='BITE_MOVE'),
        ...
        'BURNING_GROWL_MOVE': EnemyMove('BURNING_GROWL_MOVE', damage=0, block=0, hits=1, buff_power='STRENGTH_POWER', buff_amount=0, followup='PHASE3_LACERATE_MOVE'),
    },
    'THE_ADVERSARY_MK_ONE': {
        ...
        'BARRAGE_MOVE': EnemyMove('BARRAGE_MOVE', damage=0, block=0, hits=1, buff_power='STRENGTH_POWER', buff_amount=0, followup='SMASH_MOVE'),
    },
    'THE_ADVERSARY_MK_THREE': {
        ...
        'BARRAGE_MOVE': EnemyMove('BARRAGE_MOVE', damage=0, block=0, hits=1, buff_power='STRENGTH_POWER', buff_amount=0, followup='CRASH_MOVE'),
    },
    'THE_ADVERSARY_MK_TWO': {
        'BASH_MOVE': EnemyMove('BASH_MOVE', damage=0, block=0, hits=1, followup='FLAME_BEAM_MOVE'),
        'FLAME_BEAM_MOVE': EnemyMove('FLAME_BEAM_MOVE', damage=0, block=0, hits=1, followup='BARRAGE_MOVE'),
        'BARRAGE_MOVE': EnemyMove('BARRAGE_MOVE', damage=0, block=0, hits=1, buff_power='STRENGTH_POWER', buff_amount=0, followup='BASH_MOVE'),
    },
    'THE_FORGOTTEN': {
        'MIASMA': EnemyMove('MIASMA', damage=0, block=0, hits=1, buff_power='DEXTERITY_POWER', buff_amount=0, followup=''),
    },
    'THE_INSATIABLE': {
        ...
        'SALIVATE_MOVE': EnemyMove('SALIVATE_MOVE', damage=0, block=0, hits=1, buff_power='STRENGTH_POWER', buff_amount=0, followup='THRASH_MOVE_2'),
    },
    'THE_LOST': {
        'DEBILITATING_SMOG': EnemyMove('DEBILITATING_SMOG', damage=0, block=0, hits=1, buff_power='STRENGTH_POWER', buff_amount=0, followup=''),
    ...
    'THE_OBSCURA': {
        ...
        'SAIL_MOVE': EnemyMove('SAIL_MOVE', damage=0, block=0, hits=1, buff_power='STRENGTH_POWER', buff_amount=0, followup=''),
        'HARDENING_STRIKE_MOVE': EnemyMove('HARDENING_STRIKE_MOVE', damage=7, block=7, hits=1, followup=''),
    },
    'THIEVING_HOPPER': {
        ...
        'FLUTTER_MOVE': EnemyMove('FLUTTER_MOVE', damage=0, block=0, hits=1, buff_power='FLUTTER_POWER', buff_amount=0, followup='HAT_TRICK_MOVE'),
        'ESCAPE_MOVE': EnemyMove('ESCAPE_MOVE', damage=0, block=0, hits=1, followup='ESCAPE_MOVE'),
    },
    'TOADPOLE': {
        'SPIKE_SPIT_MOVE': EnemyMove('SPIKE_SPIT_MOVE', damage=4, block=0, hits=1, buff_power='THORNS_POWER', buff_amount=0, followup='WHIRL_MOVE'),
        'WHIRL_MOVE': EnemyMove('WHIRL_MOVE', damage=8, block=0, hits=1, followup='SPIKEN_MOVE'),
        'SPIKEN_MOVE': EnemyMove('SPIKEN_MOVE', damage=0, block=0, hits=1, buff_power='THORNS_POWER', buff_amount=0, followup='SPIKE_SPIT_MOVE'),
    },
    'TORCH_HEAD_AMALGAM': {
    ...
    'TRACKER_RUBY_RAIDER': {
        'TRACK_MOVE': EnemyMove('TRACK_MOVE', damage=0, block=0, hits=1, buff_power='FRAIL_POWER', buff_amount=0, followup=''),
    ...
    'TUNNELER': {
        ...
        'BURROW_MOVE': EnemyMove('BURROW_MOVE', damage=0, block=37, hits=1, buff_power='BURROWED_POWER', buff_amount=0, followup='BELOW_MOVE'),
    ...
    'TURRET_OPERATOR': {
        ...
        'RELOAD_MOVE': EnemyMove('RELOAD_MOVE', damage=0, block=0, hits=1, buff_power='STRENGTH_POWER', buff_amount=0, followup='UNLOAD_MOVE'),
    },
    'TWIG_SLIME_M': {
    ...
    'TWO_TAILED_RAT': {
        ...
        'SCREECH_MOVE': EnemyMove('SCREECH_MOVE', damage=0, block=0, hits=1, buff_power='FRAIL_POWER', buff_amount=0, followup=''),
    ...
    'VANTOM': {
        ...
        'PREPARE_MOVE': EnemyMove('PREPARE_MOVE', damage=0, block=0, hits=1, buff_power='STRENGTH_POWER', buff_amount=0, followup='INK_BLOT_MOVE'),
    },
    'VINE_SHAMBLER': {
        'GRASPING_VINES_MOVE': EnemyMove('GRASPING_VINES_MOVE', damage=9, block=0, hits=1, buff_power='TANGLED_POWER', buff_amount=0, followup='CHOMP_MOVE'),
    ...
    'WATERFALL_GIANT': {
        'PRESSURIZE_MOVE': EnemyMove('PRESSURIZE_MOVE', damage=0, block=0, hits=1, buff_power='STEAM_ERUPTION_POWER', buff_amount=0, followup='STOMP_MOVE'),
        'STOMP_MOVE': EnemyMove('STOMP_MOVE', damage=16, block=0, hits=1, buff_power='STEAM_ERUPTION_POWER', buff_amount=0, followup='RAM_MOVE'),
        'RAM_MOVE': EnemyMove('RAM_MOVE', damage=11, block=0, hits=1, buff_power='STEAM_ERUPTION_POWER', buff_amount=0, followup='SIPHON_MOVE'),
        'SIPHON_MOVE': EnemyMove('SIPHON_MOVE', damage=0, block=0, hits=1, buff_power='STEAM_ERUPTION_POWER', buff_amount=0, followup=''),
        'PRESSURE_UP_MOVE': EnemyMove('PRESSURE_UP_MOVE', damage=14, block=0, hits=1, buff_power='STEAM_ERUPTION_POWER', buff_amount=0, followup='STOMP_MOVE'),
